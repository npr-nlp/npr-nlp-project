...
# So...what splits do we need? 
# Train
# Validate
# Test
# X_ and y_ for all
# Perhaps...create these splits with all columns, then drop as needed...
# Wait, I can't create tf-idf features and count vectorizer features on the same df
...
X_test_cv_plusfeatures = sp.sparse.hstack((X_test_cv, pd.DataFrame(X_test.question_mark_count),\
    pd.DataFrame(X_test.utterance_order),
...
##############
# define model
lm_tfidf = LogisticRegression().fit(X_train_tfid, y_train)
# add pred column
train['predicted_Xtfidf'] = lm_tfidf.predict(X_train_tfid)
validate['predicted_Xtfidf'] = lm_tfidf.predict(X_validate_tfid)
test['predicted_Xtfidf'] = lm_tfidf.predict(X_test_tfid)
# append to eval df
...
##############
# define model
clf_tfidf = clf.fit(X_train_tfid, y_train)
# pred cols
train['predicted_clf_tfidf'] = clf_tfidf.predict(X_train_tfid)
validate['predicted_clf_tfidf'] = clf_tfidf.predict(X_validate_tfid)
test['predicted_clf_tfidf'] = clf_tfidf.predict(X_test_tfid)
# append eval df
...
##############
# define model
rf_tfidf = rf.fit(X_train_tfid, y_train)
# pred cols
train['predicted_rf_tfidf'] = rf_tfidf.predict(X_train_tfid)
validate['predicted_rf_tfidf'] = rf_tfidf.predict(X_validate_tfid)
test['predicted_rf_tfidf'] = rf_tfidf.predict(X_test_tfid)
# append eval df
